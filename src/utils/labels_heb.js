export const FIELD_LABELS = {
    ...
    times_borrowed: "הושאל {count} פעמים",
    ...
    send_general_reminder: "שלח תזכורת",
    sending_general_reminder: "שולח...",
    confirm_general_reminder: "לשלוח תזכורת החזרה עבור כל {count} הספרים המושאלים?",
    general_reminder_success: "נשלחה תזכורת עבור {count} ספר(ים).",
    general_reminder_success_per_loan: "נשלחו תזכורות נפרדות עבור {count} ספר(ים).",
    general_reminder_partial: "נשלחו {sent} מתוך {total} תזכורות. חלקן נכשלו.",
    general_reminder_no_email: "לחבר זה אין אימייל — לא ניתן לשלוח תזכורת.",
    general_reminder_no_books: "לחבר זה אין ספרים מושאלים.",
    general_reminder_failed: "שליחת התזכורת נכשלה. נסה שוב.",
    general_reminder_recent: "כבר נשלחה תזכורת לאחרונה עבור כל הספרים המושאלים.",
    ...
    qr_codes: "קוד QR",
    qr_code_number: "מספר",
    filter_by_added_date: "סנן לפי תאריך הוספה",
    date_from: "מ",
    date_to: "עד",
    month: "חודש",
    year: "שנה",
    clear_date_filter: "נקה סינון",
    no_qr_codes_in_range: "לא נוספו ספרים בטווח התאריכים.",
    loading_qr_codes: "טוען קודי QR...",
    complete_date_filter: "יש לבחור חודש ושנה עבור כל תאריך.",
