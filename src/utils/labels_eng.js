export const FIELD_LABELS = {
    ...
    times_borrowed: "Borrowed {count} times",
    ...
    send_general_reminder: "Send reminder",
    sending_general_reminder: "Sending...",
    confirm_general_reminder: "Send a return reminder for all {count} borrowed books?",
    general_reminder_success: "Reminder sent for {count} book(s).",
    general_reminder_success_per_loan: "Sent separate reminders for {count} book(s).",
    general_reminder_partial: "Sent {sent} of {total} reminders. Some failed.",
    general_reminder_no_email: "This member has no email — reminders cannot be sent.",
    general_reminder_no_books: "This member has no borrowed books.",
    general_reminder_failed: "Failed to send reminder. Please try again.",
    general_reminder_recent: "A reminder was already sent recently for all borrowed books.",
    ...
    filter_by_added_date: "Filter by date added",
    date_from: "From",
    date_to: "To",
    month: "Month",
    year: "Year",
    clear_date_filter: "Clear filter",
    no_qr_codes_in_range: "No books added in this date range.",
    loading_qr_codes: "Loading QR codes...",
    complete_date_filter: "Select both month and year for each date bound.",
